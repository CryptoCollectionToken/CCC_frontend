export default {
  ...
  prepare_PC_line3:'3. You need to install EOS SCATTER plug-ins in the browser;',
  ...
  prepare_mobile_line1: '1. You need to use wallet that can directly connect to EOS DAPP, such as MEET ONE, TokenPocket, and 51 Token, etc.',
  ...
  prepare_excel_2_1_before: '1 face value of ',
  ...
  prepare_exchange_5: 'V. Collectors can set up a constant auction price, which need to set the auction cycle, taking 2 hours as one unit. The shortest auction time is 2 hours, and the longest auction time is 48 hours. If the deal of Crypto Commemorative TOKENS cannot be finished by setting auction cycle deadline, they will be automatically pulled from the shelves. The collectors need to sell Crypto Commemorative TOKENS again, and collectors are not allowed to remove Crypto Commemorative TOKENS being auctioned during the auction time;',
  prepare_exchange_6: 'VI. The collectors can also set up the floating auction price, which need to set the auction cycle, and set the initial price and the ending price. 2 hours is a time unit, and the price falling range for every 2 hours is ( initial price - end price)/(auction cycle /2). For example, if the initial price is 5EOS and the end price is 2EOS, and the auction cycle is 24 hours, then the price falling range is （5 - 2）/ （24 /2）=0.25 EOS;',
  ...
  combinereward_thematic_1: 'Collect a set of large transfer type Crypto Commemorative TOKENS can be awarded with 20000 game TOKENS , namely take as you ask for.',
  combinereward_thematic_2: 'Collect a set of smart contract platform type Crypto Commemorative TOKENS can be awarded with 14000 game TOKENS, namely take as you ask for .',
  combinereward_thematic_3: 'Collect a set of the trading platform type Crypto Commemorative TOKENS can be awarded with 12000 game TOKENS, namely take as you ask for.',
  combinereward_thematic_4: 'Collect a set of payment type Crypto Commemorative TOKENS can be awarded with 4500 game TOKENS, namely take as you ask for.',
  combinereward_thematic_5: 'Collect a set of physical and legal coin anchoring type Crypto Commemorative TOKENS can get 4000 game TOKENS rewards, namely take as you ask for.',
  combinereward_thematic_6: 'Collect a set of humorous type Crypto Commemorative TOKENS can be rewarded with 2500 game TOKENS, namely take as you ask for.',
  ...
  proof_income: 'Today current total income',
  proof_reward_for_all: 'Today current EOS rewards for all TOKEN holders',
  proof_hold: 'Today current quantity of TOKEN holders hold',
  proof_reward_for_holder: 'Today current TOKEN holders’ earnings',
  ...
  proof_repurchase: 'Today current earnings are used to repurchase game TOKEN',
  proof_need: 'Today current TOKEN amount is needed to repurchase',
  proof_price: 'Today current TOKEN repurchase price',
  ...
  refer_users: '1-10 Active Users',
  refer_reward_for_each_user: '30 TOKEN for each user',
  refer_note: 'Note:',
  refer_note_1: '"Active Collector" means that invitee conduct mining Crypto Commemorative TOKEN at least once or buy Crypto Commemorative TOKEN at least once',
