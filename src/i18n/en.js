export default {
  ...
  prepare_m_PC_line3:'3. You need to install EOS SCATTER plug-ins in the browser;',
  prepare_m_PC_line6:'EOS SCATTER Installation tutorial:',
  ...
  prepare_excel_3: 'III.',
  prepare_excel_3_1: '1. 65% of the EOS paid by collectors for mining will be distributed to all game TOKENS holders on average, which will be distributed every 3 days automatically at 12:00 PM Beijing time.',
  prepare_excel_3_2: '2. 20% of the transaction fee is used to repurchase the game TOKEN that the game TOKEN holders need to sell, and it is distributed every 7 days, each player is only able to sell game TOKEN once each round.',
  prepare_excel_3_3: '3. 15% of the EOS paid by collectors for mining shall be awarded to all collectors who collect the whole edition of Crypto Commemorative Tokens (including all denominations of banknotes and coins) , and it is distributed every 24 hours automatically at 12:00 PM Beijing time. Collectors make decisions by yourselves to receive EOS reward or not in this round based on EOS Prize Pool amount. If no collector collects a complete edition of Crypto Commemorative Tokens or collectors collect a complete edition of  Crypto Commemorative Tokens not decide to receive EOS reward in this round, the EOS reward will be added to the next round automatically and continuously;',
  ...
  combinereward_rule_2: '2. Collect whole edition Crypto Commemorative TOKENS with EOS coin as the reward, and the reward is floating, depending on the daily income of the game. The reward consists of 15% of the daily mining income and 15% of the daily auction transaction fee income. If no collector receives in this issue, the reward will be automatically accumulated to the next issue, which will be distributed at 12:00 PM Beijing time.',
  ...
  combinereward_rule_5: '5. The game has a Crypto Commemorative TOKENS exchange mechanism, in order to ensure the game running in a fair, set the reward anti-cheating system. For example, after collectors collected a set of the whole edition of Bitcoin Crypto Commemorative TOKEN, and got a set of the whole edition Bitcoin collection reward, only when they have two sets of the whole edition Bitcoin Crypto Commemorative TOKENS at the same time, they can get the whole edition Bitcoin collection reward again.The Commemorative Coins which receiving the combined awards need to be frozen for 30 days, and then they can be sold and exchanged again',
  ...
  proof_need: 'This round (each round lasts 7 days) current TOKEN amount is needed to repurchase',
  proof_price: 'This round(each round lasts 7 days) current TOKEN repurchase price',
